...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100 relative h-screen max-w-full">
        ...
        <div class="w-10 h-10 absolute" style="bottom: 12%; left: 50%; transform: translate(-50%, -50%)">
            <a href="#intro" data-aos-delay="800" class="w-full h-full rounded-md cursor-pointer bg-white shadow flex items-center justify-center" data-aos="zoom-in">
