...
if (!function_exists("curl_init")) {
    ...
    function get_check_curl_init_key($ch)
    {
        ...
        if (!isset($curl_init__map[$key])) {
            throw new Exception(
                HTTP::HTTPTranslate(
                    "cURL Emulator:  Unable to find key mapping for resource."
                )
            );
        }
    ...
    function curl_version($age = CURLVERSION_NOW)
    {
        ...
        $result = [
            "version_number" =>
                ($curlvernum[0] << 16) | ($curlvernum[1] << 8) | $curlvernum[2],
            "age" => $age,
            "features" =>
                CURL_VERSION_IPV6 |
                (defined("OPENSSL_VERSION_TEXT") ? CURL_VERSION_SSL : 0) |
                CURL_VERSION_DEBUG |
            ...
            "version" => $curlversion,
            "host" => "i386-pc-win32",
            "ssl_version" => defined("OPENSSL_VERSION_TEXT")
                ? implode(
                    "/",
                    array_slice(explode(" ", OPENSSL_VERSION_TEXT), 0, 2)
                )
                : "",
            "libz_version" => "",
    ...
    function curl_error($ch)
    {
        ...
        return $curl_init__map[$key]["errorinfo"] == ""
            ? ""
            : $curl_error__map[$curl_init__map[$key]["errorno"]] .
                    " - " .
    ...
    function curl_setopt($ch, $option, $value)
    {
        ...
        if ($option != CURLINFO_HEADER_OUT) {
            if ($value === null) {
                unset($curl_init__map[$key]["options"][$option]);
            } else {
                if ($option == CURLOPT_HTTPGET && $value) {
                    $curl_init__map[$key]["method"] = "GET";
                } elseif ($option == CURLOPT_NOBODY && $value) {
                    $curl_init__map[$key]["method"] = "HEAD";
                } elseif ($option == CURLOPT_POST && $value) {
                    $curl_init__map[$key]["method"] = "POST";
                } elseif ($option == CURLOPT_PUT && $value) {
                    $curl_init__map[$key]["method"] = "PUT";
                } elseif ($option == CURLOPT_CUSTOMREQUEST) {
                    $curl_init__map[$key]["method"] = $value;
                }
    ...
    function curl_exec($ch)
    {
        ...
        if (isset($curl_init__map[$key]["options"][CURLOPT_PROTOCOLS])) {
            $allowedprotocols["http"] =
                (bool) ($curl_init__map[$key]["options"][CURLOPT_PROTOCOLS] &
                    CURLPROTO_HTTP);
            $allowedprotocols["https"] =
                (bool) ($curl_init__map[$key]["options"][CURLOPT_PROTOCOLS] &
                    CURLPROTO_HTTPS);
        }
        $curl_init__map[$key]["browser"]->SetState([
        ...
        if (isset($curl_init__map[$key]["options"][CURLOPT_REDIR_PROTOCOLS])) {
            $allowedprotocols["http"] =
                (bool) ($curl_init__map[$key]["options"][
        ...
        $curl_init__map[$key]["browser"]->SetState([
            "allowedredirprotocols" => $allowedprotocols,
        ]);

        // Load cookies.  Violates the PHP/cURL definition a lot.  Whatever.
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_COOKIEFILE]) &&
            is_string($curl_init__map[$key]["options"][CURLOPT_COOKIEFILE]) &&
        ...
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_COOKIESESSION]) &&
        ...
        $curl_init__map[$key]["browser"]->SetState([
            "autoreferer" =>
                isset($curl_init__map[$key]["options"][CURLOPT_AUTOREFERER]) &&
                $curl_init__map[$key]["options"][CURLOPT_AUTOREFERER],
        ]);

        // Set the Referer.
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_REFERER]) &&
            is_string($curl_init__map[$key]["options"][CURLOPT_REFERER])
        ) {
            $curl_init__map[$key]["browser"]->SetState([
                "referer" => $curl_init__map[$key]["options"][CURLOPT_REFERER],
            ]);
        }
        ...
        $curl_init__map[$key]["browser"]->SetState([
            "followlocation" =>
                isset(
                    $curl_init__map[$key]["options"][CURLOPT_FOLLOWLOCATION]
                ) && $curl_init__map[$key]["options"][CURLOPT_FOLLOWLOCATION],
        ]);
        $curl_init__map[$key]["browser"]->SetState([
            "maxfollow" => isset(
                $curl_init__map[$key]["options"][CURLOPT_MAXREDIRS]
            )
                ? $curl_init__map[$key]["options"][CURLOPT_MAXREDIRS]
                : 20,
        ]);
        ...
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_CONNECTTIMEOUT]) ||
            isset($curl_init__map[$key]["options"][CURLOPT_CONNECTTIMEOUT_MS])
        ) {
            $timeout =
                (isset($curl_init__map[$key]["options"][CURLOPT_CONNECTTIMEOUT])
                    ? $curl_init__map[$key]["options"][CURLOPT_CONNECTTIMEOUT]
                    : 0) +
                (isset(
                    $curl_init__map[$key]["options"][CURLOPT_CONNECTTIMEOUT_MS]
                )
                    ? $curl_init__map[$key]["options"][
        ...
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_TIMEOUT]) ||
            isset($curl_init__map[$key]["options"][CURLOPT_TIMEOUT_MS])
        ) {
            $timeout =
                (isset($curl_init__map[$key]["options"][CURLOPT_TIMEOUT])
                    ? $curl_init__map[$key]["options"][CURLOPT_TIMEOUT]
                    : 0) +
                (isset($curl_init__map[$key]["options"][CURLOPT_TIMEOUT_MS])
                    ? $curl_init__map[$key]["options"][CURLOPT_TIMEOUT_MS]
                    : 0) /
                    1000;
            if ($timeout > 0) {
                $options["connecttimeout"] = $timeout;
        ...
        if (isset($curl_init__map[$key]["options"][CURLOPT_PROXY])) {
            if (
                isset($curl_init__map[$key]["options"][CURLOPT_PROXYTYPE]) &&
                $curl_init__map[$key]["options"][CURLOPT_PROXYTYPE] !=
                    CURLPROXY_HTTP
            ) {
                $curl_init__map[$key]["errorno"] = CURLE_UNSUPPORTED_PROTOCOL;
                $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                    "CURLOPT_PROXYTYPE option is unsupported."
                );
            ...
            if (strpos($proxyurl, "://") === false) {
                $proxyurl =
                    ($proxyport == 443 ? "https://" : "http://") . $proxyurl;
            }
            ...
            if (isset($curl_init__map[$key]["options"][CURLOPT_PROXYUSERPWD])) {
                $userpass = explode(
                    ":",
                    $curl_init__map[$key]["options"][CURLOPT_PROXYUSERPWD]
                );
                if (count($userpass) == 2) {
            ...
            if (
                isset($curl_init__map[$key]["options"][CURLOPT_HTTPPROXYTUNNEL])
            ) {
        ...
        // Set SSL options.
        $options["sslopts"] = [];
        $options["sslopts"]["verify_peer"] = isset(
            $curl_init__map[$key]["options"][CURLOPT_SSL_VERIFYPEER]
        )
            ? $curl_init__map[$key]["options"][CURLOPT_SSL_VERIFYPEER]
            : true;
        if (isset($curl_init__map[$key]["options"][CURLOPT_CAINFO])) {
            $options["sslopts"]["cafile"] =
                $curl_init__map[$key]["options"][CURLOPT_CAINFO];
        }
        if (isset($curl_init__map[$key]["options"][CURLOPT_CAPATH])) {
            $options["sslopts"]["capath"] =
                $curl_init__map[$key]["options"][CURLOPT_CAPATH];
        }
        if (
            !isset($options["sslopts"]["cafile"]) &&
            !isset($options["sslopts"]["capath"])
        ) {
            $options["sslopts"]["auto_cainfo"] = true;
        }
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_SSLCERT]) &&
            isset($curl_init__map[$key]["options"][CURLOPT_SSLKEY])
        ) {
            if (
                $curl_init__map[$key]["options"][CURLOPT_SSLCERT] !==
                $curl_init__map[$key]["options"][CURLOPT_SSLKEY]
            ) {
                $curl_init__map[$key]["errorno"] = CURLE_SSL_CONNECT_ERROR;
                $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                    "CURLOPT_SSLCERT and CURLOPT_SSLKEY must be identical."
                );

                return false;
            }
            $certpass = isset(
                $curl_init__map[$key]["options"][CURLOPT_SSLCERTPASSWD]
            )
                ? $curl_init__map[$key]["options"][CURLOPT_SSLCERTPASSWD]
                : false;
            $keypass = isset(
                $curl_init__map[$key]["options"][CURLOPT_SSLKEYPASSWD]
            )
                ? $curl_init__map[$key]["options"][CURLOPT_SSLKEYPASSWD]
                : false;
            if ($certpass !== $keypass) {
                $curl_init__map[$key]["errorno"] = CURLE_SSL_CONNECT_ERROR;
                $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                    "CURLOPT_SSLCERTPASSWD and CURLOPT_SSLKEYPASSWD must be identical."
                );

                return false;
            }
            $certtype = strtoupper(
                isset($curl_init__map[$key]["options"][CURLOPT_SSLCERTTYPE])
                    ? $curl_init__map[$key]["options"][CURLOPT_SSLCERTTYPE]
                    : "PEM"
            );
            $keytype = strtoupper(
                isset($curl_init__map[$key]["options"][CURLOPT_SSLKEYTYPE])
                    ? $curl_init__map[$key]["options"][CURLOPT_SSLKEYTYPE]
                    : "PEM"
            );
        ...
        if (isset($curl_init__map[$key]["options"][CURLOPT_SSL_CIPHER_LIST])) {
            $options["sslopts"]["ciphers"] =
                $curl_init__map[$key]["options"][CURLOPT_SSL_CIPHER_LIST];
        }
        $options["sslopts"]["auto_cn_match"] = true;
        $options["sslopts"]["auto_sni"] = true;
        $options["sslopts"]["capture_peer_cert"] = isset(
            $curl_init__map[$key]["options"][CURLOPT_CERTINFO]
        )
            ? $curl_init__map[$key]["options"][CURLOPT_CERTINFO]
            : false;
        ...
        // Set the method.
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_UPLOAD]) &&
            (bool) $curl_init__map[$key]["options"][CURLOPT_UPLOAD]
        ) {
            $options["method"] = "PUT";
        } else {
        ...
        if (isset($curl_init__map[$key]["options"][CURLOPT_HTTP_VERSION])) {
            if (
                $curl_init__map[$key]["options"][CURLOPT_HTTP_VERSION] ==
        ...
        if (
            isset(
                $curl_init__map[$key]["options"][CURLOPT_MAX_RECV_SPEED_LARGE]
            )
        ) {
        ...
        if (
            isset(
                $curl_init__map[$key]["options"][CURLOPT_MAX_SEND_SPEED_LARGE]
            )
        ) {
            $options["sendratelimit"] =
                $curl_init__map[$key]["options"][CURLOPT_MAX_SEND_SPEED_LARGE];
        }
        ...
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_HTTPHEADER]) &&
            is_array($curl_init__map[$key]["options"][CURLOPT_HTTPHEADER])
        ) {
            foreach (
                $curl_init__map[$key]["options"][CURLOPT_HTTPHEADER]
                as $header
            ) {
                $pos = strpos($header, ":");
                if ($pos !== false) {
                    ...
                    if ($val == "") {
                        ...
                        $options["headers"][
                            HTTP::HeaderNameCleanup(substr($header, 0, $pos))
                        ] = $val;
                    }
                }
            }
        ...
        if (isset($curl_init__map[$key]["options"][CURLOPT_USERAGENT])) {
            $options["headers"]["User-Agent"] =
                $curl_init__map[$key]["options"][CURLOPT_USERAGENT];
        }
        if (isset($curl_init__map[$key]["options"][CURLOPT_COOKIE])) {
            $options["headers"]["Cookie"] =
                $curl_init__map[$key]["options"][CURLOPT_COOKIE];
        }
        if (isset($curl_init__map[$key]["options"][CURLOPT_RANGE])) {
            $options["headers"]["Range"] =
                "bytes=" . $curl_init__map[$key]["options"][CURLOPT_RANGE];
        }
        if (isset($curl_init__map[$key]["options"][CURLOPT_RESUME_FROM])) {
            $options["headers"]["Range"] =
                "bytes=" .
                $curl_init__map[$key]["options"][CURLOPT_RESUME_FROM] .
                "-";
        }
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_TIMECONDITION]) &&
            isset($curl_init__map[$key]["options"][CURLOPT_TIMEVALUE])
        ) {
            if (
                $curl_init__map[$key]["options"][CURLOPT_TIMECONDITION] ==
                CURL_TIMECOND_IFMODSINCE
            ) {
                $options["headers"]["If-Modified-Since"] =
                    gmdate(
                        "D, d M Y H:i:s",
                        $curl_init__map[$key]["options"][CURLOPT_TIMEVALUE]
                    ) . " GMT";
            } elseif (
                $curl_init__map[$key]["options"][CURLOPT_TIMECONDITION] ==
                CURL_TIMECOND_IFUNMODSINCE
            ) {
                $options["headers"]["If-Unmodified-Since"] =
                    gmdate(
                        "D, d M Y H:i:s",
                        $curl_init__map[$key]["options"][CURLOPT_TIMEVALUE]
                    ) . " GMT";
                ...
                foreach ($vals as $num => $val) {
                    ...
                    if (substr($val, 0, 1) == "@") {
                        ...
                        if (file_exists($val)) {
                            ...
                            $options["files"][] = [
                                "name" => $name,
                                "filename" => HTTP::FilenameSafe(
                                    HTTP::ExtractFilename($val)
                                ),
                                "type" => $mimetype,
                                "datafile" => $val,
                            ];
        ...
        // Process the URL.
        if (
            !isset($curl_init__map[$key]["options"][CURLOPT_URL]) ||
            !is_string($curl_init__map[$key]["options"][CURLOPT_URL]) ||
            $curl_init__map[$key]["options"][CURLOPT_URL] == ""
        ) {
            $curl_init__map[$key]["errorno"] = CURLE_URL_MALFORMAT;
            $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                "No CURLOPT_URL option specified."
            );
        ...
        if ($url["scheme"] == "") {
            $curl_init__map[$key]["errorno"] = CURLE_URL_MALFORMAT;
            $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                "CURLOPT_URL does not have a scheme."
            );
        ...
        if ($url["host"] == "") {
            $curl_init__map[$key]["errorno"] = CURLE_URL_MALFORMAT;
            $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                "CURLOPT_URL does not specify a valid host."
            );

            return false;
        }
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_PORT]) &&
            (int) $curl_init__map[$key]["options"][CURLOPT_PORT] > 0 &&
            (int) $curl_init__map[$key]["options"][CURLOPT_PORT] < 65536
        ) {
        ...
        if (isset($curl_init__map[$key]["options"][CURLOPT_USERPWD])) {
            $userpass = explode(
                ":",
                $curl_init__map[$key]["options"][CURLOPT_USERPWD]
            );
            if (count($userpass) == 2) {
            ...
            isset($curl_init__map[$key]["options"][CURLOPT_NETRC]) &&
            $curl_init__map[$key]["options"][CURLOPT_NETRC]
        ) {
        ...
        $options["read_headers_callback"] =
            "internal_curl_read_headers_callback";
        $options["read_headers_callback_opts"] = $key;

        if (
            !isset($curl_init__map[$key]["options"][CURLOPT_NOBODY]) ||
            !$curl_init__map[$key]["options"][CURLOPT_NOBODY]
        ) {
        ...
        if ($options["method"] != "GET" && $options["method"] != "POST") {
            $options["write_body_callback"] =
                "internal_curl_write_body_callback";
        ...
        if (
            ...
            $curl_init__map[$key]["browser"]->SetState(["cookies" => []]);
        } elseif (isset($curl_init__map[$key]["options"][CURLOPT_COOKIEJAR])) {
            ...
            file_put_contents(
                $curl_init__map[$key]["options"][CURLOPT_COOKIEJAR],
                serialize($state["cookies"])
            );
        }
        ...
        if (!$result["success"]) {
            if ($result["errorcode"] == "allowed_protocols") {
                $curl_init__map[$key]["errorno"] = CURLE_UNSUPPORTED_PROTOCOL;
                $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                    "The cURL emulation layer does not support the protocol or was redirected to an unsupported protocol by the host.  %s",
                    $result["error"]
                );
            } elseif ($result["errorcode"] == "allowed_redir_protocols") {
                $curl_init__map[$key]["errorno"] = CURLE_UNSUPPORTED_PROTOCOL;
                $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                    "The cURL emulation layer was redirected to an unsupported protocol by the host.  %s",
                    $result["error"]
                );
            } elseif ($result["errorcode"] == "retrievewebpage") {
                if ($result["info"]["errorcode"] == "timeout_exceeded") {
                    $curl_init__map[$key]["errorno"] = CURLE_OPERATION_TIMEDOUT;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "The operation timed out.  %s",
                        $result["error"]
                    );
                } elseif ($result["info"]["errorcode"] == "get_response_line") {
                    $curl_init__map[$key]["errorno"] = CURLE_READ_ERROR;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "Unable to get the response line.  %s",
                        $result["error"]
                    );
                } elseif (
                    $result["info"]["errorcode"] == "read_header_callback"
                ) {
                    $curl_init__map[$key]["errorno"] = CURLE_READ_ERROR;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "A read error occurred in the read header callback.  %s",
                        $result["error"]
                    );
                } elseif (
                    $result["info"]["errorcode"] == "read_body_callback"
                ) {
                    $curl_init__map[$key]["errorno"] = CURLE_READ_ERROR;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "A read error occurred in the read body callback.  %s",
                        $result["error"]
                    );
                } elseif ($result["info"]["errorcode"] == "function_check") {
                    $curl_init__map[$key]["errorno"] = CURLE_FUNCTION_NOT_FOUND;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "A required function was not found.  %s",
                        $result["error"]
                    );
                } elseif ($result["info"]["errorcode"] == "protocol_check") {
                    $curl_init__map[$key][
                        "errorno"
                    ...
                    $result["info"]["errorcode"] == "transport_not_installed"
                ) {
                    $curl_init__map[$key]["errorno"] = CURLE_NOT_BUILT_IN;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "The cURL emulation layer attempted to use a required transport to connect to a host but failed.  %s",
                        $result["error"]
                    );
                } elseif (
                    $result["info"]["errorcode"] ==
                    "proxy_transport_not_installed"
                ) {
                    $curl_init__map[$key]["errorno"] = CURLE_NOT_BUILT_IN;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "The cURL emulation layer attempted to use a required transport to connect to a proxy but failed.  %s",
                        $result["error"]
                    );
                } elseif ($result["info"]["errorcode"] == "proxy_connect") {
                    $curl_init__map[$key]["errorno"] = CURLE_COULDNT_CONNECT;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "Unable to connect to the proxy.  %s",
                        $result["error"]
                    );
                } elseif (
                    $result["info"]["errorcode"] == "proxy_connect_tunnel"
                ) {
                    $curl_init__map[$key]["errorno"] = CURLE_COULDNT_CONNECT;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "Unable to open a tunnel through the connected proxy.  %s",
                        $result["error"]
                    );
                } elseif ($result["info"]["errorcode"] == "connect_failed") {
                    $curl_init__map[$key]["errorno"] = CURLE_COULDNT_CONNECT;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "Unable to connect to the host.  %s",
                        $result["error"]
                    );
                } elseif (
                    $result["info"]["errorcode"] == "write_body_callback"
                ) {
                    $curl_init__map[$key]["errorno"] = CURLE_WRITE_ERROR;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "A write error occurred in the write body callback.  %s",
                        $result["error"]
                    );
                } elseif ($result["info"]["errorcode"] == "file_open") {
                    $curl_init__map[$key][
                        "errorno"
                    ] = CURLE_FILE_COULDNT_READ_FILE;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "Unable to open file for upload.  %s",
                        $result["error"]
                    );
                } elseif ($result["info"]["errorcode"] == "file_read") {
                    $curl_init__map[$key]["errorno"] = CURLE_READ_ERROR;
                    $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                        "A read error occurred while uploading a file.  %s",
                        $result["error"]
                    );
                } else {
                    $curl_init__map[$key][
        ...
        if (
            isset($curl_init__map[$key]["returnresponse"]) &&
            $curl_init__map[$key]["returnresponse"]["code"] >= 400 &&
            isset($curl_init__map[$key]["options"][CURLOPT_FAILONERROR]) &&
            $curl_init__map[$key]["options"][CURLOPT_FAILONERROR]
        ) {
            $curl_init__map[$key]["errorno"] = CURLE_HTTP_RETURNED_ERROR;
            $curl_init__map[$key]["errorinfo"] = HTTP::HTTPTranslate(
                "A HTTP error occurred.  %s",
                $curl_init__map[$key]["returnresponse"]["line"]
            );
        ...
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_RETURNTRANSFER]) &&
            $curl_init__map[$key]["options"][CURLOPT_RETURNTRANSFER]
        ) {
            return (isset($curl_init__map[$key]["returnheader"])
                ? $curl_init__map[$key]["returnheader"] . "\r\n"
                : "") .
                (isset($curl_init__map[$key]["returnbody"])
                    ? $curl_init__map[$key]["returnbody"]
                    : "");
        }
    ...
    function internal_curl_debug_callback($type, $data, $key)
    {
        ...
        if ($type == "proxypeercert") {
            if (
                isset($curl_init__map[$key]["options"][CURLOPT_CERTINFO]) &&
                $curl_init__map[$key]["options"][CURLOPT_CERTINFO]
            ) {
        ...
        } elseif ($type == "rawproxyheaders") {
            if (
                isset(
                    $curl_init__map[$key]["options"]["__CURLINFO_HEADER_OUT"]
                ) &&
                $curl_init__map[$key]["options"]["__CURLINFO_HEADER_OUT"]
            ) {
        ...
        if (
            $output !== "" &&
            isset($curl_init__map[$key]["options"][CURLOPT_VERBOSE]) &&
            $curl_init__map[$key]["options"][CURLOPT_VERBOSE]
        ) {
            if (
                isset($curl_init__map[$key]["options"][CURLOPT_STDERR]) &&
                is_resource($curl_init__map[$key]["options"][CURLOPT_STDERR])
            ) {
                fwrite(
                    $curl_init__map[$key]["options"][CURLOPT_STDERR],
                    $output
                );
    ...
    function internal_curl_write_body_callback(&$body, &$bodysize, $key)
    {
        ...
        if (!$bodysize) {
            if (!isset($curl_init__map[$key]["options"][CURLOPT_INFILESIZE])) {
                return false;
            }
            $bodysize = $curl_init__map[$key]["options"][CURLOPT_INFILESIZE];
        } elseif (
            isset($curl_init__map[$key]["options"][CURLOPT_READFUNCTION])
        ) {
            $bodysize2 = $bodysize > 32768 ? 32768 : $bodysize;
            $bodysize3 = $bodysize2;
            $body = $curl_init__map[$key]["options"][CURLOPT_READFUNCTION](
                $curl_init__map[$key]["self"],
                $curl_init__map[$key]["options"][CURLOPT_INFILE],
                $bodysize2
            );
            if ($bodysize3 < strlen($body)) {
                if (
                    ...
                    $output = HTTP::HTTPTranslate(
                        "An error occurred in the read function callback while reading the data to send/upload to the host."
                    );
            ...
            if (
                !isset($curl_init__map[$key]["options"][CURLOPT_INFILE]) ||
                !is_resource($curl_init__map[$key]["options"][CURLOPT_INFILE])
            ) {
                return false;
            }
            if ($bodysize > 32768) {
            ...
            if ($body === false) {
                if (
                    ...
                    $output = HTTP::HTTPTranslate(
                        "An error occurred while reading the data to send/upload to the host."
                    );
    ...
    function internal_curl_read_headers_callback(&$response, &$headers, $key)
    {
        ...
        if (isset($curl_init__map[$key]["returnresponse"])) {
            $data = "";
        } else {
            $data = $response["line"] . "\r\n";
        ...
        if (
            isset($curl_init__map[$key]["options"][CURLOPT_HEADER]) &&
            ...
            if (
                ...
                if (
                    ...
                    fwrite(
                        $curl_init__map[$key]["options"][CURLOPT_STDERR],
                        HTTP::HTTPTranslate("Header:\n") . $data
                    );
                } elseif (defined("STDERR")) {
                    fwrite(STDERR, HTTP::HTTPTranslate("Header:\n") . $data);
                } else {
                    echo HTTP::HTTPTranslate("Header:\n") . $data;
                }
            }
        }
        ...
        if (
            ...
            if (
                ...
                if (
                    isset(
                        $curl_init__map[$key]["options"][CURLOPT_WRITEHEADER]
                    ) &&
                    is_resource(
                        $curl_init__map[$key]["options"][CURLOPT_WRITEHEADER]
                    )
                    ...
                    if (!isset($curl_init__map[$key]["returnheader"])) {
                        $curl_init__map[$key]["returnheader"] = $data;
                    } else {
                        $curl_init__map[$key]["returnheader"] .= $data;
                    }
                } elseif (!$curl_init__map[$key]["outputbody"]) {
                    if (
                        isset($curl_init__map[$key]["options"][CURLOPT_FILE]) &&
                        is_resource(
                            $curl_init__map[$key]["options"][CURLOPT_FILE]
                        )
                    ) {
                        fwrite(
                            $curl_init__map[$key]["options"][CURLOPT_FILE],
            ...
            if (
                isset(
                    $curl_init__map[$key]["options"][CURLOPT_HEADERFUNCTION]
                ) &&
                $curl_init__map[$key]["options"][CURLOPT_HEADERFUNCTION]
            ) {
                $curl_init__map[$key]["options"][CURLOPT_HEADERFUNCTION](
    ...
    function internal_curl_read_body_callback(&$response, $data, $key)
    {
        ...
        if (
            ...
            if (!isset($curl_init__map[$key]["returnbody"])) {
                $curl_init__map[$key]["returnbody"] = "";
            }
            ...
            if (
                ...
                $curl_init__map[$key]["returnbody"] .= $data;
            } else {
                if (
                    isset($curl_init__map[$key]["options"][CURLOPT_FILE]) &&
                    is_resource($curl_init__map[$key]["options"][CURLOPT_FILE])
                ) {
                    fwrite(
                        $curl_init__map[$key]["options"][CURLOPT_FILE],
                        $data
            ...
            if (
                ...
                if (
                    ...
                    fwrite(
                        $curl_init__map[$key]["options"][CURLOPT_STDERR],
                        HTTP::HTTPTranslate("Body:\n") . $data
                    );
                } elseif (defined("STDERR")) {
                    fwrite(STDERR, HTTP::HTTPTranslate("Body:\n") . $data);
                } else {
                    echo HTTP::HTTPTranslate("Body:\n") . $data;
                }
            }

            if (
                isset(
                    $curl_init__map[$key]["options"][CURLOPT_WRITEFUNCTION]
                ) &&
                $curl_init__map[$key]["options"][CURLOPT_WRITEFUNCTION]
            ) {
                $datasize = strlen($data);
                $size = $curl_init__map[$key]["options"][CURLOPT_WRITEFUNCTION](
                    $curl_init__map[$key]["self"],
                    $data
                );
                if ($size != $datasize) {
                    if (
                        ...
                        $output = HTTP::HTTPTranslate(
                            "An error occurred in the write function callback while writing the data received from the host."
                        );
    ...
    function curl_getinfo($ch, $opt = 0)
    {
        ...
        $result = [
            ...
            "content_type" =>
                isset($curl_init__map[$key]["lastresult"]["headers"]) &&
                isset(
                    $curl_init__map[$key]["lastresult"]["headers"][
                        "Content-Type"
                    ]
                )
                    ? $curl_init__map[$key]["lastresult"]["headers"][
                    ...
                    : null,
            "http_code" =>
                isset($curl_init__map[$key]["lastresult"]["response"]) &&
                isset($curl_init__map[$key]["lastresult"]["response"]["code"])
                    ? (int) $curl_init__map[$key]["lastresult"]["response"][
                        "code"
                    ]
                    : null,
            "header_size" => isset(
                $curl_init__map[$key]["lastresult"]["rawrecvheadersize"]
            )
                ? $curl_init__map[$key]["lastresult"]["rawrecvheadersize"]
                : 0,
            "request_size" => isset(
                $curl_init__map[$key]["lastresult"]["totalrawsendsize"]
            )
                ? $curl_init__map[$key]["lastresult"]["totalrawsendsize"]
                : 0,
            "filetime" =>
                isset($curl_init__map[$key]["options"][CURLOPT_FILETIME]) &&
                $curl_init__map[$key]["options"][CURLOPT_FILETIME] &&
                isset($curl_init__map[$key]["lastresult"]["headers"]) &&
                isset(
                    $curl_init__map[$key]["lastresult"]["headers"][
                        "Last-Modified"
                    ...
                    : -1,
            "ssl_verify_result" => 0,
            "redirect_count" => isset(
                $curl_init__map[$key]["lastresult"]["numredirects"]
            )
                ? $curl_init__map[$key]["lastresult"]["numredirects"]
                : 0,
            "total_time" =>
                isset($curl_init__map[$key]["lastresult"]["startts"]) &&
                isset($curl_init__map[$key]["lastresult"]["endts"])
                    ? $curl_init__map[$key]["lastresult"]["endts"] -
                        $curl_init__map[$key]["lastresult"]["startts"]
                    : 0,
            "namelookup_time" =>
                isset($curl_init__map[$key]["lastresult"]["startts"]) &&
                isset($curl_init__map[$key]["lastresult"]["connected"])
                    ? ($curl_init__map[$key]["lastresult"]["connected"] -
                            $curl_init__map[$key]["lastresult"]["startts"]) /
                        2
                    : 0,
            "connect_time" =>
            ...
            "pretransfer_time" =>
                isset($curl_init__map[$key]["lastresult"]["connected"]) &&
                isset($curl_init__map[$key]["lastresult"]["sendstart"])
                    ? $curl_init__map[$key]["lastresult"]["sendstart"] -
                        $curl_init__map[$key]["lastresult"]["connected"]
                    : 0,
            "size_upload" =>
                isset($curl_init__map[$key]["lastresult"]["rawsendsize"]) &&
                isset($curl_init__map[$key]["lastresult"]["rawsendheadersize"])
                    ? $curl_init__map[$key]["lastresult"]["rawsendsize"] -
                        $curl_init__map[$key]["lastresult"]["rawsendheadersize"]
                    : 0,
            "size_download" =>
                isset($curl_init__map[$key]["lastresult"]["rawrecvsize"]) &&
                isset($curl_init__map[$key]["lastresult"]["rawrecvheadersize"])
                    ? $curl_init__map[$key]["lastresult"]["rawrecvsize"] -
                        $curl_init__map[$key]["lastresult"]["rawrecvheadersize"]
                    : 0,
        ];

        $result["speed_download"] =
            isset($curl_init__map[$key]["lastresult"]["recvstart"]) &&
            isset($curl_init__map[$key]["lastresult"]["endts"]) &&
            $curl_init__map[$key]["lastresult"]["endts"] -
                $curl_init__map[$key]["lastresult"]["recvstart"] >
                0
        ...
        $result["download_content_length"] =
            isset($curl_init__map[$key]["lastresult"]["headers"]) &&
            isset(
                $curl_init__map[$key]["lastresult"]["headers"]["Content-Length"]
            )
                ? $curl_init__map[$key]["lastresult"]["headers"][
                    "Content-Length"
                ][0]
        ...
        $result["starttransfer_time"] =
            isset($curl_init__map[$key]["lastresult"]["startts"]) &&
            isset($curl_init__map[$key]["lastresult"]["sendstart"])
                ? $curl_init__map[$key]["lastresult"]["sendstart"] -
                    $curl_init__map[$key]["lastresult"]["startts"]
                : 0;
        $result["redirect_time"] =
            isset($curl_init__map[$key]["lastresult"]["firstreqts"]) &&
            isset($curl_init__map[$key]["lastresult"]["redirectts"])
                ? $curl_init__map[$key]["lastresult"]["redirectts"] -
                    $curl_init__map[$key]["lastresult"]["firstreqts"]
                : 0;
    ...
    function curl_multi_exec($mh, &$still_running)
    {
        ...
        foreach ($curl_multi_init__map[$key]["handles"] as $key2 => $ch) {
            curl_exec($ch);
            $curl_multi_init__map[$key]["messages"][] = [
                "msg" => CURLMSG_DONE,
    ...
    function curl_multi_select($mh, $timeout = 1.0)
    {
        ...
        if (!count($curl_multi_init__map[$key]["handles"])) {
            return -1;
        }
