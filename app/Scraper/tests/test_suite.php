...
DisplayParseSelectorResult(TagFilter::ParseSelector("a [href]"));
DisplayParseSelectorResult(
    TagFilter::ParseSelector('a[href="http://domain.com/"]')
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("a[href='http://domain.com/']")
);
...
DisplayParseSelectorResult(
    TagFilter::ParseSelector("tr.gotclass.moreclass.moarclass")
);
...
DisplayParseSelectorResult(
    TagFilter::ParseSelector("input:enabled,button:disabled")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("input:checked, input:checked + span")
);
...
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable tr:nth-child(-n+4)")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable td:nth-child(3n+1)")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("ul > li:nth-last-child(odd)")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("ol > li:nth-last-child(even)")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable tr:nth-last-child(-n+4)")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable td:nth-last-child(3n+1)")
);
...
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable td:first-child")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable td:last-child")
);
...
DisplayParseSelectorResult(TagFilter::ParseSelector("div.maindiv > p ~ p"));
DisplayParseSelectorResult(
    TagFilter::ParseSelector('div.maindiv *:not([title^="super "])')
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector('div.maindiv *:not([title*=" ion "])')
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector('div.maindiv *:not([title$=" cannon"])')
);
...
DisplayParseSelectorResult(
    TagFilter::ParseSelector("input:not(:enabled),button:not(:disabled)")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("input:not(:checked), input:not(:checked) + span")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("ul > li:not(:nth-child(odd))")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("ol > li:not(:nth-child(even))")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable tr:not(:nth-child(-n+4))")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable td:not(:nth-child(3n+1))")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("ul > li:not(:nth-last-child(odd))")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("ol > li:not(:nth-last-child(even))")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable tr:not(:nth-last-child(-n+4))")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable td:not(:nth-last-child(3n+1))")
);
DisplayParseSelectorResult(TagFilter::ParseSelector("p:not(:nth-of-type(3))"));
DisplayParseSelectorResult(
    TagFilter::ParseSelector("p:not(:nth-last-of-type(3))")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable td:not(:first-child)")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("table.maintable td:not(:last-child)")
);
...
DisplayParseSelectorResult(
    TagFilter::ParseSelector("div.maindiv > div.inside p")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("div.maindiv + div.other ~ p")
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector("div.maindiv + div.other p")
);
...
DisplayParseSelectorResult(TagFilter::ParseSelector('.\5cm'));
DisplayParseSelectorResult(
    TagFilter::ParseSelector(".impossible\ class\ name")
);
DisplayParseSelectorResult(TagFilter::ParseSelector(".escaped\.class\.name"));
DisplayParseSelectorResult(
    TagFilter::ParseSelector("div.maindiv & div.inner, p")
);
...
DisplayParseSelectorResult(
    TagFilter::ParseSelector(
        "p:not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span):not(.span)"
    )
);
DisplayParseSelectorResult(
    TagFilter::ParseSelector(
        "p:first-child:first-child:first-child:first-child:first-child:first-child:first-child:first-child:first-child:first-child:first-child:first-child:first-child:first-child:first-child:first-child:first-child"
    )
);
...
DisplayParseSelectorResult(
    TagFilter::ParseSelector(
        "div:not(#other).notclass:not(.nope).test#theid#theid"
    )
);
...
echo "----------------------------\n";
$sel =
    "p.someclass.anotherclass#theid[attr][attr2=val]:first-child:not(a):not(.nope)#theid.someclass,@invalid";
echo $sel . "\n";
...
$purifyoptions = [
    ...
    "allowed_attrs" => ["img" => "src", "a" => "href,id", "p" => "class"],
    "required_attrs" => ["img" => "src", "a" => "href"],
    "allowed_classes" => ["p" => "allowedclass"],
...
function DisplayTFNFindResult($msg, $tfn, $result)
{
    ...
    foreach ($result["ids"] as $id) {
        ...
        echo "    Node:        " .
            json_encode($tfn->nodes[$id], JSON_UNESCAPED_SLASHES) .
            "\n";
        echo "    Outer HTML:  " . $tfn->GetOuterHTML($id) . "\n";
        echo "    Inner HTML:  " . $tfn->GetInnerHTML($id) . "\n";
        echo "    Plain text:  " . $tfn->GetPlainText($id) . "\n";
        if (isset($tfn->nodes[$id]["attrs"]["href"])) {
            echo "    href:        " . $tfn->nodes[$id]["attrs"]["href"] . "\n";
        }
        if (isset($tfn->nodes[$id]["attrs"]["src"])) {
            echo "    src:         " . $tfn->nodes[$id]["attrs"]["src"] . "\n";
        }
    }
...
function DisplayOOTFNFindResults($msg, $results)
{
    ...
    foreach ($results as $id => $row) {
        ...
        echo "    Tag:         " . $row->Tag($id) . "\n";
        echo "    Node:        " .
            json_encode($row->Node(), JSON_UNESCAPED_SLASHES) .
            "\n";
...
DisplayTFNFindResult(
    "Filter(Find('a'), '[href]')",
    $tfn,
    $tfn->Filter($tfn->Find("a"), "[href]")
);
DisplayTFNFindResult("Find('a[href]')", $tfn, $tfn->Find("a[href]"));
DisplayTFNFindResult("Find('p')", $tfn, $tfn->Find("p"));
DisplayTFNFindResult(
    "Filter(Find('p'), 'a[href]')",
    $tfn,
    $tfn->Filter($tfn->Find("p"), "a[href]")
);
DisplayTFNFindResult(
    "Filter(Find('p'), '/contains:A link')",
    $tfn,
    $tfn->Filter($tfn->Find("p"), "/contains:A link")
);
DisplayTFNFindResult(
    "Filter(Find('p'), '/~contains:a link')",
    $tfn,
...
foreach ($result["ids"] as $id) {
    echo "  " .
        $id .
        ":  " .
        ($tfn->Move("<img src=\"awesome.jpg\">", $id, true)
            ? "true"
            : "false") .
        "\n";
}
...
foreach ($result["ids"] as $id) {
    echo "  " .
        $id .
        ":  " .
        ($tfn->Move($id, $tfn->nodes[$id]["parent"], 0) ? "true" : "false") .
        "\n";
}
echo "\n";
...
foreach ($result["ids"] as $id) {
    echo "  " .
        $id .
        ":  " .
        ($tfn->SetOuterHTML($id, "<img src=\"cool.jpg\">") ? "true" : "false") .
        "\n";
}
echo "\n";
...
foreach ($result["ids"] as $id) {
    echo "  " .
        $id .
        ":  " .
        ($tfn->SetInnerHTML($id, "<b>" . $tfn->GetInnerHTML($id) . "</b>")
            ? "true"
            : "false") .
        "\n";
}
...
DisplayTFNFindResult(
    ...
    $tfn,
    $tfn->Find("p:first-of-type")
);
DisplayTFNFindResult(
    "Find('p:last-of-type')",
    $tfn,
    $tfn->Find("p:last-of-type")
);
DisplayTFNFindResult(
    "Find('a b:only-of-type')",
    $tfn,
    $tfn->Find("a b:only-of-type")
);
DisplayTFNFindResult(
    "Find('p:nth-of-type(1)')",
    $tfn,
    $tfn->Find("p:nth-of-type(1)")
);
DisplayTFNFindResult(
    "Find('p:nth-last-of-type(2)')",
    $tfn,
    $tfn->Find("p:nth-last-of-type(2)")
);
...
DisplayOOTFNFindResults(
    "Find('p')->Filter('a[href]')",
    $root->Find("p")->Filter("a[href]")
);
...
if (!$result["success"]) {
    ...
    echo "[FAIL] An unexpected response code was returned.  " .
    ...
    foreach ($rows as $row) {
        echo "\t" .
            HTTP::ConvertRelativeToAbsoluteURL($result["url"], $row->href) .
            "\n";
    }
}
...
foreach ($urls as $url) {
    ...
    $pages[$url]->ProcessAsync($helper, $url, null, $url, ["debug" => true]);
}
...
while ($result["success"]) {
    ...
    foreach ($result["removed"] as $key => $info) {
        ...
        if (!$info["result"]["success"]) {
            echo "[FAIL] Error retrieving URL (" .
                $key .
                ").  " .
                $info["result"]["error"] .
                "\n";
        } elseif ($info["result"]["response"]["code"] != 200) {
            echo "[FAIL] Error retrieving URL (" .
                $key .
                ").  Server returned:  " .
                $info["result"]["response"]["line"] .
                "\n";
        } else {
            echo "[PASS] The expected response was returned (" .
                $key .
                ").  " .
                strlen($info["result"]["body"]) .
                " bytes returned.\n";
        }
...
// An error occurred.
if (!$result["success"]) {
    echo "[FAIL] Error in Wait().  " . $result["error"] . "\n";
}
?>
